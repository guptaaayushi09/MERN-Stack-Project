      ...
      <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride='carousel' style={{objectFit:"contain !important "}}>
        <div class="carousel-caption  " style={{ zIndex: "10" }}>
          <form class="d-flex" role="search">
            <input
              ...
              aria-label="Search"
            />
            <button class="btn btn-outline-success text-white bg-succcess" type="submit">
              Search
            </button>{" "}
          </form>
        </div>
        <div class="carousel-inner"  id ='carousel'>
          <div class="carousel-item active">
            <img
              src="https://source.unsplash.com/random/30*30/?chai"
              class="d-block w-100"
          ...
          <div class="carousel-item">
            <img
              src="https://source.unsplash.com/random/30*30/?pizza"
              class="d-block w-100"
              style={{ filter: "brightness(30%)" }}
              alt="..."
            />
